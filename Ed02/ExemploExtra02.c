...
void method_12(void)
{
    ...
    if (x != y && x != z && y != z)
    {
        if ((x > y && x < z) || (x < y && x > z))
        {
            printf("\n%s\n", "O primeiro caractere está dentro do intervalo definido pelo segundo e o terceiro.");
        }
        else
        {
            printf("\n%s\n", "O primeiro caractere não está dentro do intervalo definido pelo segundo e o terceiro.");
        }
    }
    else if (x == y || x == z || y == z)
    {
        printf("\n%s\n", "O primeiro caractere é igual ao segundo ou ao terceiro.");
    }
    else
    {
        printf("\n%s\n", "Os três caracteres são iguais.");
    }
} // end method_12

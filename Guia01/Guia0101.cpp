...
#include "karel.hpp"
// comentário: necessario estar na mesma pasta
...
int main()
{
        ...
        set_Speed(3);
        // definir velocidade padrao// criar robo
        ...
        robot->turnLeft();
        robot->turnOff();
        // primeira acao: andar para frente (falta ';')
        // outra acao : mover-se de novo
        // virar 'a esquerda
        // desligar-se

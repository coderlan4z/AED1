/*
Guia_0210 - v0.0. - __ / __ / _____
Author: _____________________
Para compilar em uma janela de comandos (terminal):
No Linux
: g++ -o Guia0210
No Windows: g++ -o Guia0210
./Guia0201.cpp
Guia0201.cpp
...
int main()
{
  ...
  0.4        01. ( OK ) teste da repeticao para pegar um beeper
  0.5        01. ( OK ) teste de exibicao da mensagem
  0.6        01. ( OK ) teste de acao por comandos
  0.7        01. ( OK ) teste de gravacao de acoes
  0.8        01. ( OK ) teste de execucao de acoes
  0.9        01. ( OK ) teste de traducao de acoes
  1.0        01. ( OK ) teste de gravacao de acoes
